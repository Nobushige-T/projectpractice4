...
<body>
    <?php 
    session_start();
    echo "ようこそ、".$_SESSION['login_user'][0]."さん";
?>
    <div id="page-all">
        <div id="header">
                        ...
                        <div class="tab_contents" id="student_contents">
                            <div class="description">
                                <form method="POST" action="tourokukari.html">
                                    <!-- disabledにしているものは既に登録しているデータを引っ張ってくる想定 -->                                    <p>名前:<input type="text" name="name" value="瀬戸口 洋子" disabled></p>
                                    ...
                                    or <input type="text" name="sex" value="女性" disabled></p>
                                    ...
                                    <p>学校名: <input type="text" name="school" value="神戸大学" disabled></p><!-- 登録するときは学校区分あったほうがいいかも -->
                                    <p>学部・学科: <input type="text" name="department" value="工学部情報知能工学科" disabled></p>
                                    <!-- プロフィール写真は略 -->
